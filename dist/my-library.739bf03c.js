...
var _paginator = require("../js/Paginator");
var _paginatorDefault = parcelHelpers.interopDefault(_paginator);
let dataLength = 1000;
const pageSize = 20;
const paginator = new (0, _paginatorDefault.default)((0, _paginatorDefault.default).getCurrentPage(), pageSize, dataLength);
paginator.render();

},{"../js/Paginator":"eeu8y","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"eeu8y":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class Paginator {
    ...
    render() {
        ...
        if (this.page > 3) this.divPagination.insertAdjacentHTML("beforeend", this.getBtnOne());
        if (5 <= this.page) this.divPagination.insertAdjacentHTML("beforeend", this.getBtnDot(this.getDotPage(1, prevPage)));
        if (2 <= this.page <= lastPage - 1) {
            for(let i = prevPage; i <= nextPage; i++)if (i === this.page) this.divPagination.insertAdjacentHTML("beforeend", this.getBtnActive(i));
            else this.divPagination.insertAdjacentHTML("beforeend", this.getBtnDefault(i));
        }
        if (this.page < lastPage - 4) this.divPagination.insertAdjacentHTML("beforeend", this.getBtnDot(this.getDotPage(nextPage, lastPage)));
        if (this.page < lastPage - 2) this.divPagination.insertAdjacentHTML("beforeend", this.getBtnLast(this.pageCount));
...
//# sourceMappingURL=my-library.739bf03c.js.map
