...
})({"ySU6q":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "427073d671fac9ae";
...
},{}],"ifYU2":[function(require,module,exports) {
...
var _fetchMoviesDefault = parcelHelpers.interopDefault(_fetchMovies);
...
async function onShowMovies(event) {
    ...
    if (query === "") $refs.message.classList.remove("visually-hidden");
    else {
        ...
        (0, _fetchAPIDefault.default)(fetchMovies, loadMovies);
    }
    $refs.form.reset();
}
function loadMovies(response) {
    if (response.data.results.length === 0) $refs.message.classList.remove("visually-hidden");
    else {
        $refs.message.classList.add("visually-hidden");
        // renderMovieCard(response);
        $refs.gallery.innerText = "";
        (0, _fetchMoviesDefault.default)(response);
    }
}
...
},{"./fetchAPI":"8zw2P","./fetchMovies":"34BkJ","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ySU6q","ifYU2"], "ifYU2", "parcelRequired7c6")

//# sourceMappingURL=index.71fac9ae.js.map
