...
})({"1cDyT":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "7ac8ef27e2574f45";
...
},{}],"34BkJ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _fetchAPI = require("./fetchAPI");
var _fetchAPIDefault = parcelHelpers.interopDefault(_fetchAPI);
var _authApp = require("./authApp");
var _authAppDefault = parcelHelpers.interopDefault(_authApp);
var _paginator = require("./Paginator");
var _paginatorDefault = parcelHelpers.interopDefault(_paginator);
console.log((0, _paginatorDefault.default).getCurrentPage());
...
function getGenreList() {
    ...
    (0, _fetchAPIDefault.default)(URL, getGenreById);
}
function getPopularMovies() {
    const page = (0, _paginatorDefault.default).getCurrentPage();
    const pageQueryStr = `&page=${page}`;
    const URL = `https://api.themoviedb.org/3/trending/movie/day?api_key=${API_KEY}` + pageQueryStr;
    (0, _fetchAPIDefault.default)(URL, renderMoviesCardsMarkup);
}
...
function getMovieInfo(id) {
    ...
    (0, _fetchAPIDefault.default)(URL, (0, _authAppDefault.default));
}
...
exports.default = renderMoviesCardsMarkup;
startfilm();

},{"./fetchAPI":"8zw2P","./authApp":"5oHXW","./Paginator":"eeu8y","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8zw2P":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./../utils":"5By4s"}]},["1cDyT","34BkJ"], "34BkJ", "parcelRequired7c6")

//# sourceMappingURL=index.e2574f45.js.map
